 ...
 */
class Apron extends \App\Entity\Apron implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Apron' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Apron' . "\0" . 'title', 'stands'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Apron $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setTitle(string $title): \App\Entity\Apron
    {
    ...
    public function getStands()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStands', []);

        return parent::getStands();
    }

    /**
     * {@inheritDoc}
     */
    public function setStands(\App\Entity\Stand $stands)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStands', [$stands]);

        return parent::setStands($stands);
    }
