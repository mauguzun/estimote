...
class UserRole extends \App\Entity\UserRole implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\UserRole' . "\0" . 'id', '' . "\0" . 'App\\Entity\\UserRole' . "\0" . 'name', '' . "\0" . 'App\\Entity\\UserRole' . "\0" . 'description', 'permissions'];
        }
    ...
    public function permissionsToArray()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'permissionsToArray', []);

        return parent::permissionsToArray();
    }
