 ...
 */
class Stand extends \App\Entity\Stand implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Stand' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Stand' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Stand' . "\0" . 'longitude', '' . "\0" . 'App\\Entity\\Stand' . "\0" . 'latitude', '' . "\0" . 'App\\Entity\\Stand' . "\0" . 'raport'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Stand $proxy) {
